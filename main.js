...
const SERVICE_DETAILS = {
  ...
  zekeringkasten: {
    ...
    intro: 'Een overzichtelijke en correct beveiligde verdeelkast vormt het hart van uw elektrische installatie. BenTech brengt de situatie in kaart en werkt toe naar een veilige, keuringsklare oplossing.',
  ...
  herstellingen: {
    ...
    imageAlt: 'Illustratief beeld van een elektricien aan een elektrische installatie',
  ...
  installaties: {
    ...
    intro: 'Voor nieuwbouw, renovatie en uitbreiding verzorgt BenTech een samenhangende elektrische installatie met aandacht voor veiligheid, toekomstig gebruik en een nette afwerking.',
    image: 'assets/service-elektriciteitsinstallatie-v2.webp',
  ...
  laadpalen: {
    ...
    image: 'assets/installateur-sfeerbeeld-20260904.webp',
    imageAlt: 'Illustratief beeld van een installateur bij een laadpaal',
    visualLabel: 'Illustratief beeld: laadpaalinstallatie',
