...
// Lazily loads p5.js and vanta.topology only for desktop viewports (>= 769px with fine pointer).
// Mobile devices and users with prefers-reduced-motion never load or execute this script.
